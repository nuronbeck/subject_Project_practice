<?php 
	...
	{
		$deleting_service_id = $_POST["service_select"];

		$url_del = "http://localhost/lab_2/deleteService/".$deleting_service_id;


		$delete_request = json_decode(file_get_contents($url_del));

		if ($delete_request->result == "Service deleted")
		{
...
<body>
	...
	<div class="nav_cl">Удалить услугу</div>
	<div class="wrapper">
